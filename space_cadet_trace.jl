...
precompile(Tuple{typeof(Base.isequal), Widgets.Widget{:button, Int64}, Observables.Observable{Base.Dict{Any, Any}}})
...
precompile(Tuple{typeof(Base.isequal), Widgets.Widget{:tabs, Any}, Observables.Observable{Base.Dict{Any, Any}}})
...
precompile(Tuple{typeof(Base.isequal), Observables.Observable{Base.Dict{Any, Any}}, Observables.Observable{Array{Union{Bool, Int64}, 1}}})
...
precompile(Tuple{typeof(Base.string), Float64, String, String, String})
